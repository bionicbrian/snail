...
var vec__31233_31236 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_31237 = cljs.core.nth.call(null,vec__31233_31236,(0),null);
var only_after_31238 = cljs.core.nth.call(null,vec__31233_31236,(1),null);
var db_changed_QMARK__31239 = (!((only_before_31237 == null))) || (!((only_after_31238 == null)));
if(db_changed_QMARK__31239){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_31237);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_31238);
...
var map__31240 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__31240__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__31240__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29455__auto___31245 = arguments.length;
var i__29456__auto___31246 = (0);
while(true){
if((i__29456__auto___31246 < len__29455__auto___31245)){
args__29462__auto__.push((arguments[i__29456__auto___31246]));

var G__31247 = (i__29456__auto___31246 + (1));
i__29456__auto___31246 = G__31247;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq31244){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31244));
});
...
var args__29462__auto__ = [];
var len__29455__auto___31253 = arguments.length;
var i__29456__auto___31254 = (0);
while(true){
if((i__29456__auto___31254 < len__29455__auto___31253)){
args__29462__auto__.push((arguments[i__29456__auto___31254]));

var G__31255 = (i__29456__auto___31254 + (1));
i__29456__auto___31254 = G__31255;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__31248_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__31249_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__31249_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq31250){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__31251,G__31252,seq31250__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1508424078403
