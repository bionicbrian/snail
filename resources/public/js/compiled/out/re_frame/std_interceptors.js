...
var vec__31292_31295 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_31296 = cljs.core.nth.call(null,vec__31292_31295,(0),null);
var only_after_31297 = cljs.core.nth.call(null,vec__31292_31295,(1),null);
var db_changed_QMARK__31298 = (!((only_before_31296 == null))) || (!((only_after_31297 == null)));
if(db_changed_QMARK__31298){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_31296);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_31297);
...
var db = cljs.core.get.call(null,map__31299__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var map__31301 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__31301__$1;
var event = cljs.core.get.call(null,map__31301__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29455__auto___31304 = arguments.length;
var i__29456__auto___31305 = (0);
while(true){
if((i__29456__auto___31305 < len__29455__auto___31304)){
args__29462__auto__.push((arguments[i__29456__auto___31305]));

var G__31306 = (i__29456__auto___31305 + (1));
i__29456__auto___31305 = G__31306;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq31303){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31303));
});
...
var args__29462__auto__ = [];
var len__29455__auto___31312 = arguments.length;
var i__29456__auto___31313 = (0);
while(true){
if((i__29456__auto___31313 < len__29455__auto___31312)){
args__29462__auto__.push((arguments[i__29456__auto___31313]));

var G__31314 = (i__29456__auto___31313 + (1));
i__29456__auto___31313 = G__31314;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__31307_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__31308_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__31308_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq31309){
var G__31310 = cljs.core.first.call(null,seq31309);
var seq31309__$1 = cljs.core.next.call(null,seq31309);
var G__31311 = cljs.core.first.call(null,seq31309__$1);
var seq31309__$2 = cljs.core.next.call(null,seq31309__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__31310,G__31311,seq31309__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1508541442555
