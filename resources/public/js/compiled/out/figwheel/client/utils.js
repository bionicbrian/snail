...
return (new CustomEvent(event_name,(function (){var obj35676 = {"detail":data};
return obj35676;
})()));
} else {
...
var f = (function (){var pred__35683 = cljs.core._EQ_;
var expr__35684 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35683.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35684))){
return ((function (pred__35683,expr__35684){
return (function (p1__35677_SHARP_){
return console.warn(p1__35677_SHARP_);
});
;})(pred__35683,expr__35684))
} else {
if(cljs.core.truth_(pred__35683.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35684))){
return ((function (pred__35683,expr__35684){
return (function (p1__35678_SHARP_){
return console.debug(p1__35678_SHARP_);
});
;})(pred__35683,expr__35684))
} else {
if(cljs.core.truth_(pred__35683.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35684))){
return ((function (pred__35683,expr__35684){
return (function (p1__35679_SHARP_){
return console.error(p1__35679_SHARP_);
});
;})(pred__35683,expr__35684))
} else {
return ((function (pred__35683,expr__35684){
return (function (p1__35680_SHARP_){
return console.log(p1__35680_SHARP_);
});
;})(pred__35683,expr__35684))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35687){
...
var eval_fn = cljs.core.get.call(null,map__35688__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35690_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35692,(0),null);
var v = cljs.core.nth.call(null,vec__35692,(1),null);
...
}catch (e35697){if((e35697 instanceof Error)){
var e = e35697;
return not_found;
} else {
throw e35697;
...
//# sourceMappingURL=utils.js.map?rel=1508424081920
