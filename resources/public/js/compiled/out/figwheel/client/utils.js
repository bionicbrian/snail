...
return (new CustomEvent(event_name,(function (){var obj36210 = {"detail":data};
return obj36210;
})()));
} else {
...
var f = (function (){var pred__36217 = cljs.core._EQ_;
var expr__36218 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36217.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36218))){
return ((function (pred__36217,expr__36218){
return (function (p1__36211_SHARP_){
return console.warn(p1__36211_SHARP_);
});
;})(pred__36217,expr__36218))
} else {
if(cljs.core.truth_(pred__36217.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36218))){
return ((function (pred__36217,expr__36218){
return (function (p1__36212_SHARP_){
return console.debug(p1__36212_SHARP_);
});
;})(pred__36217,expr__36218))
} else {
if(cljs.core.truth_(pred__36217.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36218))){
return ((function (pred__36217,expr__36218){
return (function (p1__36213_SHARP_){
return console.error(p1__36213_SHARP_);
});
;})(pred__36217,expr__36218))
} else {
return ((function (pred__36217,expr__36218){
return (function (p1__36214_SHARP_){
return console.log(p1__36214_SHARP_);
});
;})(pred__36217,expr__36218))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36221){
...
var opts = map__36222__$1;
var eval_fn = cljs.core.get.call(null,map__36222__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36224_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__36226,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1508541446653
