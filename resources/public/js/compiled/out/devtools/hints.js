...
var file = cljs.core.get.call(null,map__41303__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41303__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41303__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41302){var _e = e41302;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___41305 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___41305)){
var seen_errors_41306 = temp__4655__auto___41305;
if(cljs.core.truth_(seen_errors_41306.has(self))){
} else {
seen_errors_41306.add(self);

var temp__4657__auto___41307 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___41307)){
var sense_41308 = temp__4657__auto___41307;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_41308)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1508541452413
