...
var len__29455__auto___38993 = arguments.length;
var i__29456__auto___38994 = (0);
while(true){
if((i__29456__auto___38994 < len__29455__auto___38993)){
args__29462__auto__.push((arguments[i__29456__auto___38994]));

var G__38995 = (i__29456__auto___38994 + (1));
i__29456__auto___38994 = G__38995;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38990){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38991,G__38992,seq38990__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38996_SHARP_){
return !((cljs.core.meta.call(null,p1__38996_SHARP_) == null));
})))){
...
var map__38997 = opts;
var map__38997__$1 = ((((!((map__38997 == null)))?((((map__38997.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38997.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38997):map__38997);
var markup_db = cljs.core.get.call(null,map__38997__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e39001){var _e__37982__auto__ = e39001;
return false;
}})();
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
...
}catch (e39003){var _e__37982__auto__ = e39003;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39005 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39006 = opts;
...
var markup_db = cljs.core.get.call(null,map__39006__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39005;
}});
...
;
var temp__4655__auto___39010 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39010)){
var managed_print_level_39011 = temp__4655__auto___39010;
var _STAR_print_level_STAR_39009_39012 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39011;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39009_39012,managed_print_level_39011,temp__4655__auto___39010,writer,opts,job_fn){
return (function (p1__39008_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39008_SHARP_,null);
});})(_STAR_print_level_STAR_39009_39012,managed_print_level_39011,temp__4655__auto___39010,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39009_39012;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1509580233088
