...
var len__29455__auto___38991 = arguments.length;
var i__29456__auto___38992 = (0);
while(true){
if((i__29456__auto___38992 < len__29455__auto___38991)){
args__29462__auto__.push((arguments[i__29456__auto___38992]));

var G__38993 = (i__29456__auto___38992 + (1));
i__29456__auto___38992 = G__38993;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29463__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38988){
var G__38989 = cljs.core.first.call(null,seq38988);
var seq38988__$1 = cljs.core.next.call(null,seq38988);
var G__38990 = cljs.core.first.call(null,seq38988__$1);
var seq38988__$2 = cljs.core.next.call(null,seq38988__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38989,G__38990,seq38988__$2);
});
...
if(cljs.core.truth_((function (){var or__28286__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28911__auto__,writer__28912__auto__,opt__28913__auto__){
return cljs.core._write.call(null,writer__28912__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__28274__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__28274__auto__){
var or__28286__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38994_SHARP_){
return !((cljs.core.meta.call(null,p1__38994_SHARP_) == null));
})))){
...
var map__38995 = opts;
var map__38995__$1 = ((((!((map__38995 == null)))?((((map__38995.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38995.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38995):map__38995);
var markup_db = cljs.core.get.call(null,map__38995__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__28286__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38999){var _e__37980__auto__ = e38999;
return false;
}})();
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
...
}catch (e39001){var _e__37980__auto__ = e39001;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39003 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39004 = opts;
...
var markup_db = cljs.core.get.call(null,map__39004__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39003;
}});
...
;
var temp__4655__auto___39008 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39008)){
var managed_print_level_39009 = temp__4655__auto___39008;
var _STAR_print_level_STAR_39007_39010 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39009;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39007_39010,managed_print_level_39009,temp__4655__auto___39008,writer,opts,job_fn){
return (function (p1__39006_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39006_SHARP_,null);
});})(_STAR_print_level_STAR_39007_39010,managed_print_level_39009,temp__4655__auto___39008,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39007_39010;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1508696626931
