...
var o38862 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38862["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38863 = temp__4655__auto____$1;
return (o38863["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37975__auto__ = f;
return (o__37975__auto__["toString"]).call(o__37975__auto__);
} else {
return "";
}
}catch (e38864){var _ = e38864;
return "";
}});
...
try{var o__37975__auto___38866 = t;
(o__37975__auto___38866["cljs$lang$ctorPrWriter"]).call(o__37975__auto___38866,t,writer);
}catch (e38865){var __38867 = e38865;
}
...
var char_code = (function (){var o__37975__auto__ = (new String(char$));
return (o__37975__auto__["charCodeAt"]).call(o__37975__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37975__auto__ = String;
return (o__37975__auto__["fromCharCode"]).call(o__37975__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38868 = num_code;
switch (G__38868) {
case (1):
return (185);
...
var o__37975__auto__ = String;
return (o__37975__auto__["fromCharCode"]).call(o__37975__auto__,superscript_code);
});
/**
...
}catch (e38870){var _e__37982__auto__ = e38870;
return false;
}})())){
...
var vec__38871 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38871,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38874 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38874["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38875 = temp__4655__auto____$1;
return (o38875["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___38882 = arguments.length;
var i__29456__auto___38883 = (0);
while(true){
if((i__29456__auto___38883 < len__29455__auto___38882)){
args__29462__auto__.push((arguments[i__29456__auto___38883]));

var G__38884 = (i__29456__auto___38883 + (1));
i__29456__auto___38883 = G__38884;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38878){
var vec__38879 = p__38878;
var ns_detector = cljs.core.nth.call(null,vec__38879,(0),null);
...
var G__38885 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38886 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38885;
remaining_tokens = G__38886;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38876){
var G__38877 = cljs.core.first.call(null,seq38876);
var seq38876__$1 = cljs.core.next.call(null,seq38876);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38877,seq38876__$1);
});
...
var vec__38890 = cljs.core.split_with.call(null,(function (p1__38889_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38889_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38890,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38890,(1),null);
...
var vec__38893 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38893,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38893,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38896 = cljs.core.rest.call(null,remaining_tokens);
var G__38897 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38896;
name_tokens = G__38897;
continue;
} else {
...
var vec__38900 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38900,(0),null);
var arity = cljs.core.nth.call(null,vec__38900,(1),null);
var vec__38903 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38903,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38903,(1),null);
var vec__38906 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38906,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38906,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38906,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38906,(3),null);
...
var vec__38912 = result;
var munged_ns = cljs.core.nth.call(null,vec__38912,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38912,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38912,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38912,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38912,(4),null);
var arity = cljs.core.nth.call(null,vec__38912,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38916 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38916,(0),null);
var args = cljs.core.nth.call(null,vec__38916,(1),null);
var vec__38919 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38919,(0),null);
var name = cljs.core.nth.call(null,vec__38919,(1),null);
...
var G__38922 = (arity + (1));
var G__38923 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38924){
var vec__38925 = p__38924;
var arity = cljs.core.nth.call(null,vec__38925,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38925,(1),null);
...
return (function (p1__38928_SHARP_){
return cljs.core.get.call(null,arities,p1__38928_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__38929_SHARP_){
return cljs.core.drop.call(null,(2),p1__38929_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38936 = arguments.length;
var i__29456__auto___38937 = (0);
while(true){
if((i__29456__auto___38937 < len__29455__auto___38936)){
args__29462__auto__.push((arguments[i__29456__auto___38937]));

var G__38938 = (i__29456__auto___38937 + (1));
i__29456__auto___38937 = G__38938;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38932){
var vec__38933 = p__38932;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38933,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38930){
var G__38931 = cljs.core.first.call(null,seq38930);
var seq38930__$1 = cljs.core.next.call(null,seq38930);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38931,seq38930__$1);
});
...
var G__38939 = arg;
var G__38939__$1 = (((G__38939 instanceof cljs.core.Keyword))?G__38939.fqn:null);
switch (G__38939__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38941__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38941__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38941__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38941__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38942 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38942,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38942,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38942,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38942,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38942,(4),null);
var arity = cljs.core.nth.call(null,vec__38942,(5),null);
...
var o__37975__auto__ = f;
return (o__37975__auto__["getBasis"]).call(o__37975__auto__);
});
/**
...
}catch (e38946){var _e__37982__auto__ = e38946;
...
var G__38947 = (obj[cljs.core.first.call(null,path)]);
var G__38948 = cljs.core.rest.call(null,path);
obj = G__38947;
path = G__38948;
continue;
} else {
...
return (function (accum,p__38949){
var vec__38950 = p__38949;
var bit = cljs.core.nth.call(null,vec__38950,(0),null);
var protocol = cljs.core.nth.call(null,vec__38950,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38953){
var vec__38954 = p__38953;
var ns = cljs.core.nth.call(null,vec__38954,(0),null);
var name = cljs.core.nth.call(null,vec__38954,(1),null);
var selector = cljs.core.nth.call(null,vec__38954,(2),null);
...
return (function (p__38958){
var vec__38959 = p__38958;
var munged_name = cljs.core.nth.call(null,vec__38959,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38959,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38959,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38957_SHARP_){
return (obj[cljs.core.first.call(null,p1__38957_SHARP_)]);
});})(name,sorted_matches,vec__38959,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1509580232915
