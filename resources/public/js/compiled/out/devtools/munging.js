...
var o39408 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39408["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39409 = temp__4655__auto____$1;
return (o39409["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38521__auto__ = f;
return (o__38521__auto__["toString"]).call(o__38521__auto__);
} else {
return "";
}
}catch (e39410){var _ = e39410;
return "";
}});
...
try{var o__38521__auto___39412 = t;
(o__38521__auto___39412["cljs$lang$ctorPrWriter"]).call(o__38521__auto___39412,t,writer);
}catch (e39411){var __39413 = e39411;
}
...
var char_code = (function (){var o__38521__auto__ = (new String(char$));
return (o__38521__auto__["charCodeAt"]).call(o__38521__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38521__auto__ = String;
return (o__38521__auto__["fromCharCode"]).call(o__38521__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39414 = num_code;
switch (G__39414) {
case (1):
return (185);
...
var o__38521__auto__ = String;
return (o__38521__auto__["fromCharCode"]).call(o__38521__auto__,superscript_code);
});
/**
...
}catch (e39416){var _e__38528__auto__ = e39416;
return false;
}})())){
...
var vec__39417 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39417,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39420 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39420["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39421 = temp__4655__auto____$1;
return (o39421["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39424){
var vec__39425 = p__39424;
var ns_detector = cljs.core.nth.call(null,vec__39425,(0),null);
...
var G__39431 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39432 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39431;
remaining_tokens = G__39432;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39422){
var G__39423 = cljs.core.first.call(null,seq39422);
var seq39422__$1 = cljs.core.next.call(null,seq39422);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39423,seq39422__$1);
});
...
var vec__39436 = cljs.core.split_with.call(null,(function (p1__39435_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39435_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39436,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39436,(1),null);
...
var vec__39439 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39439,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39439,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39442 = cljs.core.rest.call(null,remaining_tokens);
var G__39443 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39442;
name_tokens = G__39443;
continue;
} else {
...
var vec__39446 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39446,(0),null);
var arity = cljs.core.nth.call(null,vec__39446,(1),null);
var vec__39449 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39449,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39449,(1),null);
var vec__39452 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39452,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39452,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39452,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39452,(3),null);
...
var vec__39458 = result;
var munged_ns = cljs.core.nth.call(null,vec__39458,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39458,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39458,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39458,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39458,(4),null);
var arity = cljs.core.nth.call(null,vec__39458,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39462 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39462,(0),null);
var args = cljs.core.nth.call(null,vec__39462,(1),null);
var vec__39465 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39465,(0),null);
var name = cljs.core.nth.call(null,vec__39465,(1),null);
...
var G__39468 = (arity + (1));
var G__39469 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39470){
var vec__39471 = p__39470;
var arity = cljs.core.nth.call(null,vec__39471,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39471,(1),null);
...
return (function (p1__39474_SHARP_){
return cljs.core.get.call(null,arities,p1__39474_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39475_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___39482 = arguments.length;
var i__29456__auto___39483 = (0);
while(true){
if((i__29456__auto___39483 < len__29455__auto___39482)){
args__29462__auto__.push((arguments[i__29456__auto___39483]));

var G__39484 = (i__29456__auto___39483 + (1));
i__29456__auto___39483 = G__39484;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39478){
var vec__39479 = p__39478;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39479,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39476){
var G__39477 = cljs.core.first.call(null,seq39476);
var seq39476__$1 = cljs.core.next.call(null,seq39476);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39477,seq39476__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39487__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39487__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39487__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39487__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39488 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39488,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39488,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39488,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39488,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39488,(4),null);
var arity = cljs.core.nth.call(null,vec__39488,(5),null);
...
var o__38521__auto__ = f;
return (o__38521__auto__["getBasis"]).call(o__38521__auto__);
});
/**
...
}catch (e39492){var _e__38528__auto__ = e39492;
...
var G__39493 = (obj[cljs.core.first.call(null,path)]);
var G__39494 = cljs.core.rest.call(null,path);
obj = G__39493;
path = G__39494;
continue;
} else {
...
return (function (accum,p__39495){
var vec__39496 = p__39495;
var bit = cljs.core.nth.call(null,vec__39496,(0),null);
var protocol = cljs.core.nth.call(null,vec__39496,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39499){
var vec__39500 = p__39499;
var ns = cljs.core.nth.call(null,vec__39500,(0),null);
var name = cljs.core.nth.call(null,vec__39500,(1),null);
var selector = cljs.core.nth.call(null,vec__39500,(2),null);
...
return (function (p__39504){
var vec__39505 = p__39504;
var munged_name = cljs.core.nth.call(null,vec__39505,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39505,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39505,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39503_SHARP_){
return (obj[cljs.core.first.call(null,p1__39503_SHARP_)]);
});})(name,sorted_matches,vec__39505,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1508541449726
