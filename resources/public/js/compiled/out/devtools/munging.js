...
var o38860 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38860["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38861 = temp__4655__auto____$1;
return (o38861["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37973__auto__ = f;
return (o__37973__auto__["toString"]).call(o__37973__auto__);
} else {
return "";
}
}catch (e38862){var _ = e38862;
return "";
}});
...
try{var o__37973__auto___38864 = t;
(o__37973__auto___38864["cljs$lang$ctorPrWriter"]).call(o__37973__auto___38864,t,writer);
}catch (e38863){var __38865 = e38863;
}
...
var char_code = (function (){var o__37973__auto__ = (new String(char$));
return (o__37973__auto__["charCodeAt"]).call(o__37973__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37973__auto__ = String;
return (o__37973__auto__["fromCharCode"]).call(o__37973__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38866 = num_code;
switch (G__38866) {
case (1):
return (185);
...
var o__37973__auto__ = String;
return (o__37973__auto__["fromCharCode"]).call(o__37973__auto__,superscript_code);
});
/**
...
}catch (e38868){var _e__37980__auto__ = e38868;
return false;
}})())){
...
var vec__38869 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38869,(0),null);
...
var or__28286__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38872 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38872["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38873 = temp__4655__auto____$1;
return (o38873["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___38880 = arguments.length;
var i__29456__auto___38881 = (0);
while(true){
if((i__29456__auto___38881 < len__29455__auto___38880)){
args__29462__auto__.push((arguments[i__29456__auto___38881]));

var G__38882 = (i__29456__auto___38881 + (1));
i__29456__auto___38881 = G__38882;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29463__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38876){
var vec__38877 = p__38876;
var ns_detector = cljs.core.nth.call(null,vec__38877,(0),null);
var effective_detector = (function (){var or__28286__auto__ = ns_detector;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
var G__38883 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38884 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38883;
remaining_tokens = G__38884;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38874){
var G__38875 = cljs.core.first.call(null,seq38874);
var seq38874__$1 = cljs.core.next.call(null,seq38874);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38875,seq38874__$1);
});
...
var vec__38888 = cljs.core.split_with.call(null,(function (p1__38887_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38887_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38888,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38888,(1),null);
...
var vec__38891 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38891,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38891,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38894 = cljs.core.rest.call(null,remaining_tokens);
var G__38895 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38894;
name_tokens = G__38895;
continue;
} else {
...
var vec__38898 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38898,(0),null);
var arity = cljs.core.nth.call(null,vec__38898,(1),null);
var vec__38901 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38901,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38901,(1),null);
var vec__38904 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38904,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38904,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38904,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38904,(3),null);
...
var vec__38910 = result;
var munged_ns = cljs.core.nth.call(null,vec__38910,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38910,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38910,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38910,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38910,(4),null);
var arity = cljs.core.nth.call(null,vec__38910,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38914 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38914,(0),null);
var args = cljs.core.nth.call(null,vec__38914,(1),null);
var vec__38917 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38917,(0),null);
var name = cljs.core.nth.call(null,vec__38917,(1),null);
...
var G__38920 = (arity + (1));
var G__38921 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38922){
var vec__38923 = p__38922;
var arity = cljs.core.nth.call(null,vec__38923,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38923,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28286__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__38926_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38927_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38934 = arguments.length;
var i__29456__auto___38935 = (0);
while(true){
if((i__29456__auto___38935 < len__29455__auto___38934)){
args__29462__auto__.push((arguments[i__29456__auto___38935]));

var G__38936 = (i__29456__auto___38935 + (1));
i__29456__auto___38935 = G__38936;
continue;
} else {
}
break;
...
var argseq__29463__auto__ = ((((1) < args__29462__auto__.length))?(new cljs.core.IndexedSeq(args__29462__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29463__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38930){
var vec__38931 = p__38930;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38931,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38928){
var G__38929 = cljs.core.first.call(null,seq38928);
var seq38928__$1 = cljs.core.next.call(null,seq38928);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38929,seq38928__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28286__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28274__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28286__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
var map__38939 = options;
var map__38939__$1 = ((((!((map__38939 == null)))?((((map__38939.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38939.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38939):map__38939);
var include_ns_QMARK_ = cljs.core.get.call(null,map__38939__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38939__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38939__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38939__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38940 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38940,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38940,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38940,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38940,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38940,(4),null);
var arity = cljs.core.nth.call(null,vec__38940,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28274__auto__ = protocol_ns;
if(cljs.core.truth_(and__28274__auto__)){
return cljs.core.not.call(null,(function (){var and__28274__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28286__auto__ = protocol_part;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
return fn_part;
...
var o__37973__auto__ = f;
return (o__37973__auto__["getBasis"]).call(o__37973__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28274__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28274__auto__)){
...
}catch (e38944){var _e__37980__auto__ = e38944;
...
var G__38945 = (obj[cljs.core.first.call(null,path)]);
var G__38946 = cljs.core.rest.call(null,path);
obj = G__38945;
path = G__38946;
continue;
} else {
...
var partition_bits = (function (){var or__28286__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
return (0);
...
return (function (accum,p__38947){
var vec__38948 = p__38947;
var bit = cljs.core.nth.call(null,vec__38948,(0),null);
var protocol = cljs.core.nth.call(null,vec__38948,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38951){
var vec__38952 = p__38951;
var ns = cljs.core.nth.call(null,vec__38952,(0),null);
var name = cljs.core.nth.call(null,vec__38952,(1),null);
var selector = cljs.core.nth.call(null,vec__38952,(2),null);
...
return (function (p__38956){
var vec__38957 = p__38956;
var munged_name = cljs.core.nth.call(null,vec__38957,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38957,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38955_SHARP_){
return (obj[cljs.core.first.call(null,p1__38955_SHARP_)]);
});})(name,sorted_matches,vec__38957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1508696626769
