...
var o38839 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38839["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38840 = temp__4655__auto____$1;
return (o38840["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37952__auto__ = f;
return (o__37952__auto__["toString"]).call(o__37952__auto__);
} else {
return "";
}
}catch (e38841){var _ = e38841;
return "";
}});
...
try{var o__37952__auto___38843 = t;
(o__37952__auto___38843["cljs$lang$ctorPrWriter"]).call(o__37952__auto___38843,t,writer);
}catch (e38842){var __38844 = e38842;
}
...
var char_code = (function (){var o__37952__auto__ = (new String(char$));
return (o__37952__auto__["charCodeAt"]).call(o__37952__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37952__auto__ = String;
return (o__37952__auto__["fromCharCode"]).call(o__37952__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38845 = num_code;
switch (G__38845) {
case (1):
return (185);
...
var o__37952__auto__ = String;
return (o__37952__auto__["fromCharCode"]).call(o__37952__auto__,superscript_code);
});
/**
...
}catch (e38847){var _e__37959__auto__ = e38847;
return false;
}})())){
...
var vec__38848 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38848,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38851 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38851["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38852 = temp__4655__auto____$1;
return (o38852["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___38859 = arguments.length;
var i__29456__auto___38860 = (0);
while(true){
if((i__29456__auto___38860 < len__29455__auto___38859)){
args__29462__auto__.push((arguments[i__29456__auto___38860]));

var G__38861 = (i__29456__auto___38860 + (1));
i__29456__auto___38860 = G__38861;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38855){
var vec__38856 = p__38855;
var ns_detector = cljs.core.nth.call(null,vec__38856,(0),null);
...
var G__38862 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38863 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38862;
remaining_tokens = G__38863;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38853){
var G__38854 = cljs.core.first.call(null,seq38853);
var seq38853__$1 = cljs.core.next.call(null,seq38853);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38854,seq38853__$1);
});
...
var vec__38867 = cljs.core.split_with.call(null,(function (p1__38866_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38866_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38867,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38867,(1),null);
...
var vec__38870 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38870,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38870,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38873 = cljs.core.rest.call(null,remaining_tokens);
var G__38874 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38873;
name_tokens = G__38874;
continue;
} else {
...
var vec__38877 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38877,(0),null);
var arity = cljs.core.nth.call(null,vec__38877,(1),null);
var vec__38880 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38880,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38880,(1),null);
var vec__38883 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38883,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38883,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38883,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38883,(3),null);
...
var vec__38889 = result;
var munged_ns = cljs.core.nth.call(null,vec__38889,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38889,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38889,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38889,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38889,(4),null);
var arity = cljs.core.nth.call(null,vec__38889,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38893 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38893,(0),null);
var args = cljs.core.nth.call(null,vec__38893,(1),null);
var vec__38896 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__38899 = (arity + (1));
var G__38900 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38901){
var vec__38902 = p__38901;
var arity = cljs.core.nth.call(null,vec__38902,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38902,(1),null);
...
return cljs.core.get.call(null,arities,p1__38905_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38906_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38913 = arguments.length;
var i__29456__auto___38914 = (0);
while(true){
if((i__29456__auto___38914 < len__29455__auto___38913)){
args__29462__auto__.push((arguments[i__29456__auto___38914]));

var G__38915 = (i__29456__auto___38914 + (1));
i__29456__auto___38914 = G__38915;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38909){
var vec__38910 = p__38909;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38910,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38907){
var G__38908 = cljs.core.first.call(null,seq38907);
var seq38907__$1 = cljs.core.next.call(null,seq38907);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38908,seq38907__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38918__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38918__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38918__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38918__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38919 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38919,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38919,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38919,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38919,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38919,(4),null);
var arity = cljs.core.nth.call(null,vec__38919,(5),null);
...
var o__37952__auto__ = f;
return (o__37952__auto__["getBasis"]).call(o__37952__auto__);
});
/**
...
}catch (e38923){var _e__37959__auto__ = e38923;
...
var G__38924 = (obj[cljs.core.first.call(null,path)]);
var G__38925 = cljs.core.rest.call(null,path);
obj = G__38924;
path = G__38925;
continue;
} else {
...
return (function (accum,p__38926){
var vec__38927 = p__38926;
var bit = cljs.core.nth.call(null,vec__38927,(0),null);
var protocol = cljs.core.nth.call(null,vec__38927,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38930){
var vec__38931 = p__38930;
var ns = cljs.core.nth.call(null,vec__38931,(0),null);
var name = cljs.core.nth.call(null,vec__38931,(1),null);
var selector = cljs.core.nth.call(null,vec__38931,(2),null);
...
return (function (p__38935){
var vec__38936 = p__38935;
var munged_name = cljs.core.nth.call(null,vec__38936,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38936,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38936,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38934_SHARP_){
return (obj[cljs.core.first.call(null,p1__38934_SHARP_)]);
});})(name,sorted_matches,vec__38936,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1508424085321
